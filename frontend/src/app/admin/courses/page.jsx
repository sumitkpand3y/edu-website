...
const CourseAdminPanel = () => {
  ...
  //         {
  //           question:
  //             "What is the duration of the synchronous weekend session?",
  //           answer:
  ...
  //       category: "popular",
  //       shortDescription:
  //         "Comprehensive AI applications in healthcare settings",
  ...
  const addCurriculumItem = () => {
    setCourseForm((prev) => ({
      ...
      curriculum: [
        ...prev.curriculum,
        { id: Date.now(), title: "", description: "", duration: "" },
      ],
    }));
  };

  const updateCurriculumItem = (id, field, value) => {
    setCourseForm((prev) => ({
      ...prev,
  ...
  const addMaterial = () => {
    setCourseForm((prev) => ({
      ...prev,
      materials: [...prev.materials, { id: Date.now(), title: "", file: null }],
    }));
  };
          ...
          <div className="flex justify-between items-center">
            <div>
              ...
              <p className="text-gray-600 mt-1">
                Manage your courses, curriculum, and materials
              </p>
            </div>
            <button
              onClick={() => openModal()}
