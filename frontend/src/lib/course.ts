...
export const popularCourses: PopularCourses[] = [
  ...
  export const clinicalCourses: PopularCourses[] = [
    {
      id: 5,
      title: "MSM - GMU Advanced International degree in Emergency Medicine",
      slug: "msm-gmu-emergency-medicine",
  ...
  export const managementCourses : PopularCourses[] = [
    {
      id: 9,
  ...
  const testimonials = [
    {
      ...
      content:
        "The emergency medicine fellowship program transformed my clinical practice. The curriculum was comprehensive and the faculty exceptional.",
      rating: 5,
    ...
    },
    {
      ...
      content:
        "The healthcare management courses provided me with the tools needed to lead effectively in today's complex healthcare environment.",
      rating: 5,
      image: "https://images.unsplash.com/photo-1559839734-2b71ea197ec2?w=60&h=60&fit=crop&crop=face",
    },
    {
      ...
      role: "Quality Improvement Director",
      content:
        "Aster Health Academy's quality management certification helped me implement successful improvement initiatives at my hospital.",
      rating: 5,
      image: "https://images.unsplash.com/photo-1559839734-2b71ea197ec2?w=60&h=60&fit=crop&crop=face",
    },
  ];